...
exports.upload11 = exports.upload10 = exports.upload09 = exports.upload08 = exports.upload07 = exports.upload06 = exports.upload05 = exports.upload04 = exports.upload03 = exports.upload02 = exports.upload01 = void 0;
...
function multerDiskStorageFactory(folderName) {
    return {
        destination: function (req, file, cb) {
            cb(null, "data/".concat(folderName));
        },
...
function multerFactory(idx) {
    return (0, multer_1.default)({
        storage: multer_1.default.diskStorage(multerDiskStorageFactory(destinations[idx])),
    });
}
// file upload for outstanding institution form
...
exports.upload01 = multerFactory(1);
exports.upload02 = multerFactory(2);
exports.upload03 = multerFactory(3);
exports.upload04 = multerFactory(4);
exports.upload05 = multerFactory(5);
exports.upload06 = multerFactory(6);
exports.upload07 = multerFactory(7);
exports.upload08 = multerFactory(8);
exports.upload09 = multerFactory(9);
exports.upload10 = multerFactory(10);
exports.upload11 = multerFactory(11);
