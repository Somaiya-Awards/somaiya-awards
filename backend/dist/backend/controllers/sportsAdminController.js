...
//@access PRIVATE
exports.sportsStarGirlDataHandler = (0, express_async_handler_1.default)(async (req, res) => {
...
//@access PRIVATE
exports.sportsStarBoyDataHandler = (0, express_async_handler_1.default)(async (req, res) => {
    const currentYear = new Date().getFullYear();
    const rawData = await models_1.Sports.findAll({
        where: models_1.sequelize.where(models_1.sequelize.fn("YEAR", models_1.sequelize.col("createdAt")), currentYear),
    });
...
exports.inspiringCoachDataHandler = (0, express_async_handler_1.default)(async (req, res) => {
    const currentYear = new Date().getFullYear();
    const rawData = await models_1.Sports.findAll({
        where: models_1.sequelize.where(models_1.sequelize.fn("YEAR", models_1.sequelize.col("createdAt")), currentYear),
    });
    const feedbacks = await models_1.FeedbackFive.findAll({
        where: models_1.sequelize.where(models_1.sequelize.fn("YEAR", models_1.sequelize.col("createdAt")), currentYear),
    });
    const data = [];
    for (const response of rawData) {
...
exports.sportsDataUpdater = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const applicationForm = await models_1.Sports.findOne({
...
//@access PRIVATE
exports.getNominatedNames = (0, express_async_handler_1.default)(async (req, res) => {
    let names = [];
    const result = await models_1.Sports.findAll({
        where: {
            [sequelize_1.Op.and]: [models_1.sequelize.literal("YEAR(createdAt) = YEAR(CURDATE())")],
        },
    });
