        ...
        <div className="p-1 bg-white">
            <div className="flex font-Poppins">
                ...
                <Link to="/">
                    <div className="m-5">
                        <img
                            src="https://www.somaiya.edu.in/assets/default_asset/img/somiaya-vidyavihar-logo.svg"
                            alt="kjsit-logo"
                            className="scale-125"
                        />
                    </div>
                ...
                <div className="flex items-center w-full justify-end">
                    <a href="https://www.somaiya.com/">
                        <img
                            src="https://www.somaiya.edu.in//assets/arigel_general/img/homepage/Trust.svg"
                            width="75"
                            height="54.79"
                            alt="trust-logo"
                            className="scale-100"
