...
const validator = (props, value) => {
    ...
    if (props.validateType === "textarea") {
        const validatePair = [];

        validatePair.push(props.value.length > 600);
        validatePair.push("Message is longer than 600 words");
        return validatePair;
    }
    ...
    return (
        ...
        >
            <div className="mb-3">
                ...
                {(props.type === "textarea") && validator({...props, validateType: "textarea"}, value)?.[0] && (
                    <p className="font-Poppins text-red-700">
                        {validator({...props, validateType: "textarea"}, value)?.[1]}
                    </p>
                )}
