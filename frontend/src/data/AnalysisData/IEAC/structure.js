        ...
        Swal.fire({
            ...
            .then((res) => {
                if (res.isConfirmed == true) {
                    //axios put
                    axios.put(`https://somaiyaawards.somaiya.edu/admin/ieac/data/${path}`, data, {
                        headers: {
...
const columns02: GridColDef[] = [
    ...
    { field: 'national_awards_won_count', headerName: 'National Awards Won Count', width: 250 },
    {
        field: 'evidence_of_research', headerName: 'Evidence of Research', width: 200, renderCell: (params) => {
            return <a href={`https://somaiyaawards.somaiya.edu/admin/${params.value!=null ? params.value.split("data")[1] : null}`} className="p-2 rounded-2xl cursor-pointer bg-red-700 text-white font-Poppins" download>Download</a>;
        }
    },
    {
            ...
            return params.row['ieacApproved']
                ?
                 ...
                 <a
                    ...
                    href={`https://somaiyaawards.somaiya.edu/admin/${params.row['ieacApprovedFile'].split('data')[1]}`}>
                    Download
                </a>
                :
                <input
