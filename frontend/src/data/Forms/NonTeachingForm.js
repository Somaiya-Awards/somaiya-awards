const NonTeachingForm = [
  ...
  {
    title:
      "Q1. Accepts responsibilities and performs duties above and beyond what is normally expected",
    _name: "q_01",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q2. Is flexible, responds and adapts well to internal & external changes.",
    _name: "q_02",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q3. Determines broad knowledge and competence in a work related topics",
    _name: "q_03",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q6. Brings in best practices from other Departments/ Institutes/ Universities for improvement of his/ her independent work.",
    _name: "q_06",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q7. Has shows outstanding performance which has brought attention and distinction to the Department/ University",
    _name: "q_07",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q9. Manages crises well as well as helps others to get through their crisis",
    _name: "q_09",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q10. Interacts with others in a positive, enthusiastic and cheerful manner",
    _name: "q_10",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q11. Assists others with both personal and professional challenges that impact work",
    _name: "q_11",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q12. Commands respect of co-workers, supervisor, students and clients alike",
    _name: "q_12",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q13. Suggests and/or develops new work methods which increases productivity and saves time and money",
    _name: "q_13",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q14. Recognizes work of others to increase effectiveness and identifies / addresses work problems. If any.",
    _name: "q_14",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q15. Takes the initiative to improve individual skills and knowledge.",
    _name: "q_15",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q16. Recognizes others special events and/or accomplishments, either publicly or privately.",
    _name: "q_16",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q17. Helps new employees to settle & adapt to the work environment.",
    _name: "q_17",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
  ...
  {
    title:
      "Q18. Acts as a mentor to others by providing advice, guidance, feedback and encouragement.",
    _name: "q_18",
    type: "radio",
    requiredStatus: true,
    hasOptions: true,
