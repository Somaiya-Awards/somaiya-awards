...
const Announce = () => {
        ...
        Swal.fire({
            ...
            .then((res) => {
                if (res.isConfirmed) {
                    ...
                    axios.post('https://apisomaiyaawards.somaiya.edu/admin/data/announce-results', { result: file }, {
                        headers: {
    ...
    useEffect(() => {
        ...
        const url = 'https://apisomaiyaawards.somaiya.edu/admin/data/results'
        axios.get(url, {
            headers: {
                'user_id': localStorage.getItem('user_id'),
                'x-access-token': localStorage.getItem('token')
                                            ...
                                            <>
                                                ...
                                                <div>
                                                    ...
                                                    <div className='bg-red-800 text-white p-3 hover:bg-red-400 w-52 my-8 rounded-xl text-center animate-pulse'>
                                                        <a href={`https://apisomaiyaawards.somaiya.edu${url}`} download>Download</a>
                                                    </div>
                                                </div>
                                            </>
                                            :
