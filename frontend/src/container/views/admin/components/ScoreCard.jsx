                            ...
                            <div className='mt-5'>
                                ...
                                <div className='mt-5'>
                                    ...
                                    <h3 className='text-sm my-1'>
                                        ...
                                        <span> {loading ? <Skeleton width={200} /> : (0.6*(apiData.student_avg? ((apiData.student_avg+ apiData.peers_avg)/2): (apiData.peers_avg)) + 0.4*((apiData.ieac_avg+apiData.hoi_avg)/2)).toFixed(2) }</span>
                                    </h3>
