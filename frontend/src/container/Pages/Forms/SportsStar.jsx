...
const SportsStar = () => {
  ...
  return (
    <div>
      {loading ? (
        <MoonLoader loading={loading} size={50} color="rgb(185,28,28" />
      ) : authorized ? (
        <>
          <Navbar />
            ...
            <div className="bg-red-700 text-white rounded-md shadow-lg mx-[1.5%] w-[50%] p-5">
              <div className="px-5 py-1">
                ...
                <ol className="list-decimal list-inside mx-5 mt-3">
                  ...
                  <li>
                    Inspiring Sports Incharge- Higher Education Institutes
                  </li>
                  <li>Promising Sports Coach- Somaiya Sports Academy</li>
                  <li>Inspiring Sports Coach- Somaiya Sports Academy</li>
                </ol>
              </div>

              <div className="px-5 py-2">
                <p className="font-semibold">
                  A total of 4 Sports Stars Awards to be given to outstanding
                  student athletes
                </p>
                <ol className="list-decimal list-inside mx-5 mt-3">
                  ...
                  <li>
                    Somaiya Sports Star (Girl)- Higher Education Institutes
                  </li>
                  <li>
                    Somaiya Sports Star (Boy)- Higher Education Institutes
                  </li>
                </ol>
              </div>
              ...
              <div className="my-2 px-5">
                <p className="mb-3">
                  Please nominate inspiring PE / Sports Incharge and outstanding
                  sports stars from your respective institute and upload the
